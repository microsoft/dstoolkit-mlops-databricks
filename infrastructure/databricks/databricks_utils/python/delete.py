...
from dbx_utils.create_dbx_clusters import (
    list_existing_clusters,
    get_cluster_names,
    ingest_cluster_param_file,
...
class TestListExistingClusters(unittest.TestCase):
    ...
    def test_list_existing_clusters_successfull(self, mock_get):
        """
            Test that the function returns the existing clusters successfully

            Args:
                mock_get (mock): Mock get request
            Returns:
                None
        """
        # Setup
        ...
        existing_clusters, status_code = list_existing_clusters()
    ...
    def test_list_existing_clusters_failure(self, mock_get):
        """
            Test that the function fails to return the existing clusters
...
class TestGetClusterNames(unittest.TestCase):
    def test_get_cluster_names_successful(self):
        ...
        """
            Test that the function returns the correct cluster names in a list

            Args:
                mock_existing_clusters (dict): Mock existing clusters
            Returns:
                None
        """
    ...
    def test_get_cluster_name_failure(self):
        """
            Test that the function returns the correct cluster names
...
class TestIngestClusterParamFile(unittest.TestCase):
    ...
    def test_load_json(self, mock_open):
        """
            ...
            Args:
                mock_open (mock_open): Mock open function
                test_cluster_json (json): Test cluster json
...
class TestCreateCluster(unittest.TestCase):
    ...
    def test_create_cluster_successful(self, mock_post):
        """
            ...
            Test if the create cluster function is able to create a cluster
            successfully

            Args:
                mock_post (Mock): Mock post request
            Returns:
                None
    ...
    def test_create_cluster_failure(self, mock_post):
        """
            ...
            Args:
                mock_post (Mock): Mock post request
                mock_json_cluster (json): Mock json cluster
            Returns:
                None
        """
...
class TestGetDatabricksClusterInfo(unittest.TestCase):
    ...
    def test_get_databricks_cluster_info_success(self, mock_get):
        """
            Test get databricks cluster info function
            Test if the get databricks cluster info function is able to get cluster info
        ...
        mock_get.assert_called_once_with(
            ...
            headers=expected_dbkrs_req_headers, params=databricks_cluster_id) 